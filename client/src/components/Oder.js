...
import {Card, CardText, CardBody, CardTitle, CardSubtitle, Button, Alert, Container, CardImg} from 'reactstrap';
                                ...
                                <div className="col-md-12">
                                    <Card>
                                        <CardBody>
                                            ...
                                            <CardSubtitle >Order Id: {order._id.toUpperCase()}</CardSubtitle>
                                            <div className="row">
                                            {order.items.map((item)=>(
                                                <div className="col-md-4">
                                                    <Card className="mb-2">
                                                        <CardImg src={item.productId.image}/>
                                                        <CardBody>
